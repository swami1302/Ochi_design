...
function Footer() {
  return (
    <div className="w-full h-screen flex justify-center bg-zinc-900 font-['Test_Founders_Grotesk_x-Condensed']">
      <div className='w-1/2 h-full  px-20 flex flex-col justify-between'>
        <div className="heading">
          <h1 className="text-[10vw] font-semibold uppercase leading-none -mb-10">
            eye-
          </h1>
          <h2 className="text-[10vw] font-semibold uppercase leading-none -mb-10">
            opening
          </h2>
        </div>
        <svg
